...
define('uni/utilities.dom',[],function() {
...
define('uni/utilities.object.typecheck',[],function(){
 ...
 */
define('uni/utilities.css',['require','uni/utilities.object.typecheck'],function(require) {
 ...
 */
define('uni/utilities.element.matches',[],function() {
...
define('uni/utilities.storage',[],function() {
...
define('uni/utilities.event',['require','uni/utilities.element.matches','uni/utilities.storage','uni/utilities.object.typecheck'],function(require) {
...
define('uni/utilities.element.classlist',[],function() {
...
define('uni/unicorn.core',['require','uni/utilities.dom','uni/utilities.css','uni/utilities.event','uni/utilities.element.classlist'],function(require) {
...
define('uni/utilities.object',['require','uni/utilities.object.typecheck'],function(require) {
...
define('templates/mustache.templates',{
    
    "player" : '<audio src="static/sounds/woodblock.wav "id="metronome--audio-player__player"></audio>',
    "done": "true"
  });
define('components/metronome.player',['require','uni/unicorn.core','uni/utilities.object','mustache','templates/mustache.templates'],function(require) {
...
define('components/metronome',['require','uni/unicorn.core','uni/utilities.object','components/metronome.player'],function(require) {
...
define('components/chordprogression',['require'],function(require) {
     ...
     *
     */
    var ChordProgression = function() {
        this.init.apply(this, arguments);
    };

    ChordProgression.prototype.init = function() {

    };

    ChordProgression.prototype.play = function() {

    };

    ChordProgression.prototype.stop = function() {

    };

    ChordProgression.prototype.step = function() {

    };

    ChordProgression.prototype.reset = function() {
...
define('app',['require','global','components/metronome','components/chordprogression'],function(require) {
